...
var ParentContext = /*#__PURE__*/React.createContext(null);
var ChildContext = /*#__PURE__*/React.createContext(null);
...
function ContextConsumer(_ref) {
  ...
  var ProviderStore = {};
  var ContextStore = {};
  var contextApi = React.useContext(ChildContext);
  ...
  for (var i = 0; i < ctxKey.length; i++) {
    Object.defineProperty(ContextStore, ctxKey[i], {
      value: /*#__PURE__*/React.createContext(null)
    });
  }
  ...
  var _loop = function _loop(_i) {
    ...
    ProviderStore[ctxKey[_i]] = function (_ref3) {
      ...
      var stateArray = (0, React.useState)(function () {
        return state;
      });
  ...
  function Components(_ref2) {
    ...
    return /*#__PURE__*/React.createElement(ItemComponent, null, children);
...
function Providers(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ChildContext.Provider, {
    value: context
  }, /*#__PURE__*/React.createElement(ContextConsumer, {
    context: context
  }, children));
}
...
function useStates(keyWord) {
  ...
  var context = React.useContext(cKey);
...
export { Providers, useReducers, useStates };
